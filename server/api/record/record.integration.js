...
describe('Record API:', function() {
    ...
    it('should respond with the updated record on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          record.name.should.equal('Updated Record');
          record.info.should.equal('This is the updated record!!!');
  ...
  describe('PATCH /api/records/:id', function() {
    ...
    it('should respond with the patched record', function() {
      patchedRecord.name.should.equal('Patched Record');
      patchedRecord.info.should.equal('This is the patched record!!!');
    });
  });
